...
# Web Server.C | server.c
# Trabajo de practica Redes 1 - 30/10/2012
...
void process_request(int newsockfd){	
	...
	char    buffer[1024], buffer3[3072], buffer2[256], user[128], password[128], aux[256], *envio = NULL;
	char    *tipo_mime = NULL;
...
int main(int argc, char *argv[])
{
	...
	if(bind(sockfd, (struct sockaddr *) &serv_addr, sizeof(serv_addr)) < 0) 
		error("\n\t#ERROR 14: ERROR on binding. Deves cambiar el PORTO. [Linea: 338]\n");
